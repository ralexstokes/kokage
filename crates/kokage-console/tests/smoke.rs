...
use kokage_supervisor::{ChildSpec, Supervisor, SupervisorHandle};
...
) -> (ConsoleHandle, SupervisorHandle, SupervisorHandle) {
...
async fn spawn_console() -> (ConsoleHandle, SupervisorHandle, SupervisorHandle) {
