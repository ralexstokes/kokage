...
/// # use tokio_otp::{Actor, HandleContext, ActorResult, GraphBuilder, prelude::Continue};
/// # struct Job;
/// # struct Client;
...
///
/// ```
/// # use tokio_otp::{HandleContext, ActorRef, ActorResult, Actor};
/// # struct FrontendMsg;
/// # struct ParserMsg;
/// # struct SinkMsg;
/// #
...
/// #         &mut self,
/// #         _: FrontendMsg,
/// #         _: &mut HandleContext<'_, FrontendMsg>,
/// #     ) -> ActorResult {
...
/// #     type Msg = ParserMsg;
/// #     async fn handle(&mut self, _: ParserMsg, _: &mut HandleContext<'_, ParserMsg>) -> ActorResult {
/// #         Ok(tokio_otp::prelude::Continue)
/// #     }
/// # }
/// #
...
/// # impl Actor for Sink {
/// #     type Msg = SinkMsg;
/// #     async fn handle(&mut self, _: SinkMsg, _: &mut HandleContext<'_, SinkMsg>) -> ActorResult {
/// #         Ok(tokio_otp::prelude::Continue)
/// #     }
/// # }
/// #
