//! The exhaustive multi-venue trading acceptance fixture.
//!
//! This preserves the assertion-heavy regression and observability coverage;
//! start with the reader-facing `trading_engine` example instead.
//!
