...
/// [`Always`](kokage_supervisor::RestartPolicy::Always) child restarts after it;
/// [`OnFailure`](kokage_supervisor::RestartPolicy::OnFailure) and
/// [`Never`](kokage_supervisor::RestartPolicy::Never) children do not.
///
