...
/// Handle to a running supervisor, returned by [`Supervisor::spawn`](crate::supervisor::Supervisor::spawn).
///
...
/// [`RunningSupervisor`](crate::supervisor::RunningSupervisor); dropping that owner is the
...
impl SupervisorHandle {
    ...
    /// [`ChildContext::mark_ready`](crate::supervisor::ChildContext::mark_ready); ordinary
    ...
    /// [`LifecycleWatch::direct_children`](crate::supervisor::LifecycleWatch::direct_children)
